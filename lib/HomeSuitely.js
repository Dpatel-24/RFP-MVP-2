...
export function HomeSuitely({ hotelsWithRooms, locationCopy, onSearch }) {
  ...
  const guarantees = [
    ["Answers in about ten minutes", "Your offer goes straight to the front desk. Accept, counter, or decline - you know fast, while plans are still flexible."],
        ...
        <div style={{ display: "flex", gap: 48, alignItems: "center", flexWrap: "wrap" }}>
          <div style={{ flex: "1 1 440px", minWidth: 300 }}>
            ...
            <p style={V2.sub}>
              ...
              and get a private answer in about ten minutes.
            </p>

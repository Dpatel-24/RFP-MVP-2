...
export const SL = {
  ...
  mktEyebrow:    { display:"inline-block", fontSize:12, fontWeight:700, letterSpacing:"0.08em", textTransform:"uppercase", color:"#B45309", background:"#FEF3E2", padding:"6px 12px", borderRadius:radius.xl, marginBottom:14 },
  ...
  valueCard:     { borderRadius:radius.xl, padding:"26px 22px", border:"1px solid rgba(0,0,0,0.04)", display:"flex", flexDirection:"column", gap:10 },
  valueIcon:     { width:48, height:48, borderRadius:14, background:"#fff", display:"flex", alignItems:"center", justifyContent:"center", fontSize:24 },
  ...
  stepCard:      { background:"#fff", border:border.default, borderRadius:radius.xl, padding:"26px 22px" },

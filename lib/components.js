...
export const SL = {
  ...
  typeahead:    { position:"absolute", top:"calc(100% + 8px)", left:18, right:18, background:"#fff", border:"1px solid #E5E7EB", borderRadius:12, boxShadow:"0 12px 32px rgba(0,0,0,0.16)", overflow:"hidden", zIndex:1200, maxHeight:260, overflowY:"auto" },
  ...
  // guest footer
  footerBar:        { flexShrink:0, width:"100%", background:"#fff", borderTop:"1px solid #E5E7EB" },
  footerInner:      { maxWidth:1200, margin:"0 auto", padding:"16px 24px", display:"flex", alignItems:"center", justifyContent:"space-between", gap:14 },
  footerBrand:      { display:"flex", alignItems:"center", gap:10 },
  footerLinks:      { display:"flex", alignItems:"center", gap:22 },
  footerLink:       { color:"#6B7280", fontSize:13, fontFamily:"Inter,sans-serif", fontWeight:500, textDecoration:"none" },
  // homepage marketing sections (Hopper-style, hybrid — LastKey palette)
  mktSection:    { maxWidth:1080, margin:"0 auto", padding:"56px 24px 0" },
  mktEyebrow:    { display:"inline-block", fontSize:12, fontWeight:700, letterSpacing:"0.08em", textTransform:"uppercase", color:"#B45309", background:"#FEF3E2", padding:"6px 12px", borderRadius:20, marginBottom:14 },
  mktTitle:      { fontFamily:"Space Grotesk,sans-serif", fontSize:30, fontWeight:700, letterSpacing:"-0.5px", margin:"0 0 8px", color:"#1A1F2B", lineHeight:1.15 },
  mktSub:        { fontSize:15, color:"#6B7280", margin:"0 0 30px", maxWidth:560, lineHeight:1.6 },
  valueGrid:     { display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(220px,1fr))", gap:18 },
  valueCard:     { borderRadius:20, padding:"26px 22px", border:"1px solid rgba(0,0,0,0.04)", display:"flex", flexDirection:"column", gap:10 },
  valueIcon:     { width:48, height:48, borderRadius:14, background:"#fff", display:"flex", alignItems:"center", justifyContent:"center", fontSize:24, boxShadow:"0 2px 6px rgba(0,0,0,0.06)" },
  valueCardTitle:{ fontFamily:"Space Grotesk,sans-serif", fontWeight:700, fontSize:17, color:"#1A1F2B" },
  valueCardBody: { fontSize:13.5, color:"#4B5563", lineHeight:1.6 },
  stepGrid:      { display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(240px,1fr))", gap:18 },
  stepCard:      { background:"#fff", border:"1px solid #E5E7EB", borderRadius:20, padding:"26px 22px", boxShadow:"0 1px 3px rgba(0,0,0,0.05)" },
  stepNum:       { width:40, height:40, borderRadius:"50%", background:"#F59E0B", color:"#0A0F1E", fontFamily:"Space Grotesk,sans-serif", fontWeight:700, fontSize:18, display:"flex", alignItems:"center", justifyContent:"center", marginBottom:14 },
  trustBand:     { background:"linear-gradient(120deg,#0F766E 0%,#115E59 100%)", borderRadius:24, padding:"36px 32px", color:"#fff", display:"flex", flexWrap:"wrap", gap:24, alignItems:"center", justifyContent:"space-between" },
  trustStat:     { textAlign:"center", minWidth:110 },
  trustStatNum:  { fontFamily:"Space Grotesk,sans-serif", fontWeight:700, fontSize:34, lineHeight:1, color:"#fff" },
  trustStatLbl:  { fontSize:13, color:"rgba(255,255,255,0.8)", marginTop:6 },
